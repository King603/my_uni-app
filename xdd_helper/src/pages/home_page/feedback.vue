<template>
	<view class="my-flex-col-c box my-pd-15">
		...
		<view class="box my-bder-DE my-rds-5 my-font-12">
			<textarea value="" placeholder="您遇到的问题是......" @blur="questiondetail" placeholder-class="my-cl-c3" class="txt-box my-rds-10 my-pd-10"/>
		</view>
		<view class="box my-flex-row-align-c">
			<text class="my-cl-ye my-pdt-8 my-font-20">*</text>
		...
		<view class="code my-rds-5 my-flex-row-align-c my-bder-DE">
			<view class="w-65 h my-font-12 my-pd-10 my-flex-row-align-c">
				<input type="text" :value="devId" @blur="getdeviceid" placeholder="设备编号" placeholder-class="my-cl-a3"/>
			</view>
		...
		<view class="code my-bder-DE my-flex-row-b my-rds-5 my-pd-10 my-font-12">
			<input type="text" value="" placeholder="福建厦门集美软件园三期B20栋5楼" @blur="getafteraddress" placeholder-class="my-cl-a3"/>
	...
	export default {
		...
		methods: {
			...
			toproxyrepaire(){
				...
				req.request('POST', params, '/proxy/fault-report/proxy', '加载中', (res) => {
			...
			tobusinessrepaire(){
				...
				req.request('POST', params, '/proxy/fault-report/business', '加载中', (res) => {
					if (res.statusCode === 200) {
						uni.showToast({
							title:'报修成功',
							icon:'none'
