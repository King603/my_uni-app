  ...
  <view class="my-flex-col">
    <view class="my-mglr-20 my-flex-col my-relative my-bder-b-cc">
      <view class="my-flex-row">
        ...
        <input
          type="text"
          :value="proxyinfos.proxyName"
          disabled="true"
          class="my-mgl-15 name my-mgt-2"
          :placeholder="name"
    ...
    <view class="my-mglr-20 my-flex-col my-relative">
      <view class="my-flex-row-align-c my-bder-b-cc">
        ...
        <input
          type="number"
          :value="proxyinfos.phone"
          disabled="true"
          class="my-mgl-15 my-mgt-2 mobile"
          :placeholder="mobile"
          placeholder-class="my-cl-b8"
        />
      </view>
    ...
    <view class="my-mglr-20 my-flex-col my-relative">
      <view class="my-flex-row-align-c my-bder-b-cc my-mgt-5">
        ...
        <input
          @blur="blurH60"
          type="digit"
          :value="proxyinfos.h60ProfitScale"
          class="my-mgl-15 my-mgt-2 my-bder-b profit my-cl-ye txt"
          :placeholder="h60ProfitScale"
          placeholder-class="my-cl-b8"
        />
        <text>%</text>
      </view>
    ...
    <view class="my-mglr-20 my-flex-col my-relative">
      <view class="my-flex-row-align-c my-bder-b-cc my-mgt-5">
        ...
        <input
          type="digit"
          @blur="blurX10"
          :value="proxyinfos.x10ProfitScale"
          class="my-mgl-15 my-bder-b my-mgt-2 profit my-cl-ye txt"
          :placeholder="x10ProfitScale"
          placeholder-class="my-cl-b8"
        />
        <text>%</text>
      </view>
    ...
    <view class="my-mglr-20 my-flex-col my-relative">
      <view class="my-flex-row-align-c my-bder-b-cc my-mgt-5">
        ...
        <input
          type="text"
          @blur="blurEmail"
          :value="proxyinfos.mail"
          class="my-mgl-15 my-mgt-2 e-mail"
          :placeholder="email"
          placeholder-class="my-cl-b8"
        />
      </view>
    ...
    <view class="my-fmy-flex-row-c my-fixed-b">
      <view
        @click="onAffirm"
        class="my-flex-row-c btn my-bg-ye my-cl-white my-rds-5 my-font-18 my-boxsha-2"
      >完成设置</view>
    </view>
  </view>
</template>
...
export default {
  ...
  methods: {
    ...
    onAffirm() {
      ...
      // }
      if (
        this.h60ProfitScale > this.proxyinfos.parentH60ProfitScale ||
        this.proxyinfos.h60ProfitScale > this.proxyinfos.parentH60ProfitScale
      ) {
        uni.showToast({
          title:
            "您设置的H60分润值高于设定的" +
            this.proxyinfos.parentH60ProfitScale +
            "%的值",
          icon: "none",
        });
        return;
      ...
      if (
        this.x10ProfitScale > this.proxyinfos.parentX10ProfitScale ||
        this.proxyinfos.x10ProfitScale > this.proxyinfos.parentX10ProfitScale
      ) {
        uni.showToast({
          title:
            "您设置的x10分润值高于设定的" +
            this.proxyinfos.parentX10ProfitScale +
            "%的值",
          icon: "none",
        });
        return;
      ...
      if (this.h60ProfitScale < this.proxyinfos.h60ProfitScale) {
        uni.showToast({
          title:
            "您设置的H60分润值低于之前设定的" +
            this.proxyinfos.h60ProfitScale +
            "%的值,请重新设置",
          icon: "none",
        });
        return;
      ...
      if (this.x10ProfitScale < this.proxyinfos.x10ProfitScale) {
        uni.showToast({
          title:
            "您设置的x10分润值低于之前设定的" +
            this.proxyinfos.x10ProfitScale +
            "%的值,请重新设置",
          icon: "none",
        });
        return;
