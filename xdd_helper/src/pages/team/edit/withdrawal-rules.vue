<template>
	<view class="my-pd-15 my-flex-col">
		...
		<view class="my-flex-row-c box">
			<view class="my-mgt-15 my-font-16 my-cl-white my-flex-row-c my-boxsha-2 my-bg-ye btn" @click="onAmend">确认修改</view>
		</view>
	</view>
</template>
				...
				uni.showModal({
					...
					success: res => {
						if (res.cancel) {
							...
							req.request('PUT', params, '/proxy/api/proxy/sub/' + this.id + '/withdraw', '加载中', (res) => {
								// console.log(res)
