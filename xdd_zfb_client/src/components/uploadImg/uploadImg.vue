<template>
	<view>
		<view class="zhtx-imgs">
			...
			<view v-if="limit>list.length" class="zhtx-single my-bg-white zhtx-addNew" @tap="chooseFile">
				<image class="icon" src="/static/my/camear.png" mode="aspectFit"></image>
			</view>
		</view>
	</view>
</template>
