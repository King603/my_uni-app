    ...
    <view class="uni-common-mt">
      ...
      <scroll-view class="canvas-buttons" scroll-y="true">
        <block v-for="(name, index) in names" :key="index">
          <button class="canvas-button" @click="handleCanvasButton(name)">
            {{ name }}
          </button>
        </block>
        <button class="canvas-button" @click="toTempFilePath" type="primary">
          toTempFilePath
        </button>
      </scroll-view>
    </view>
...
export default {
  ...
  methods: {
    ...
    setFontSize() {
      [10, 20, 30, 40].forEach((item, index) => {
    ...
    setLineCap() {
      ...
      ["butt", "round", "square"].forEach((item, index) => {
        context.beginPath();
    ...
    setLineJoin() {
      context.setLineWidth(10);
      ["bevel", "round", "miter"].forEach((item, index) => {
        context.beginPath();
