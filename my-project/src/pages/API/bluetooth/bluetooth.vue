  ...
  methods: {
    ...
    tapQuery(item) {
      if (this.showMaskType === "device") {
        ...
        if (this.equipment.length > 0) this.equipment[0] = item;
        else this.equipment.push(item);
        this.newDeviceLoad = false;
      }
      if (this.showMaskType === "service") {
        this.$set(this.disabled, 6, false);
        if (this.servicesData.length > 0) this.servicesData[0] = item;
        else this.servicesData.push(item);
      }
      if (this.showMaskType === "characteristics") {
        ...
        else this.characteristicsData.push(item);
      }
      this.maskShow = false;
    },
    /**
    ...
    openBluetoothAdapter() {
      uni.openBluetoothAdapter({
        ...
        fail: (e) => {
          ...
          if (e.errCode !== 0) initTypes(e.errCode, e.errMsg);
        },
      });
    },
    /**
    ...
    startBluetoothDevicesDiscovery() {
      uni.startBluetoothDevicesDiscovery({
        ...
        fail: (e) => {
          ...
          if (e.errCode !== 0) initTypes(e.errCode);
        },
      });
    },
    /**
    ...
    stopBluetoothDevicesDiscovery(types) {
      uni.stopBluetoothDevicesDiscovery({
        success: (e) => {
          ...
          this.$set(this.disabled, 1, !!types);
