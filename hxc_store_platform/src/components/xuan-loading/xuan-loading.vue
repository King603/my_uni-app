	...
	<view v-show="isPopup" class="loading-popup">
		...
		<view class="loading-content" :class="[ani]" :style="[{height:height,width:width,backgroundColor:backgroundColor}]">
			...
			<view class="circle-loading" v-show="!custom&&type==1">
				...
				<view class="dot"></view>
				<view class="dot"></view>
				<image src="https://haoxiangchong.oss-cn-shenzhen.aliyuncs.com/LaIjMKMyCu_wx023ed2d5e1a87230.o6zAJs5b-NeM9YlE0KCOW3BfXCAY.Ej1uXGtbeDXh445bc683ad5549824a454579c480c6d9.png" class="icon my-mgt-10" mode=""></image>
			</view>
			<view class="rectangle-loading" v-show="!custom&&type==2">
				<image src="https://haoxiangchong.oss-cn-shenzhen.aliyuncs.com/ntVfrckKUx_wx023ed2d5e1a87230.o6zAJs5b-NeM9YlE0KCOW3BfXCAY.PRccFUKMZFRs445bc683ad5549824a454579c480c6d9.png" class="icon my-mgr-10" mode=""></image>
				<view class="dot my-flex-self-e"></view>
				<view class="dot my-flex-self-e"></view>
				<view class="dot my-flex-self-e"></view>
			</view>
		</view>
...
<style lang="scss">
	...
	@keyframes load-frame {
		0% {height: 8px;background: palegoldenrod}
		50% {height: 16px;}
		100% {height: 8px;}
	}
