<template>
	<view class="my-flex-col-c box">
		...
		<view class="my-flex-col-c top-icon my-hdimg-c-40 my-bg-ye my-boxsha-2" v-show="top" @click="onTop">
	...
	export default {
		...
		methods: {
			getProxy(){
				...
				req.request('POST', params, '/proxy/api/proxy/sub/'+this.proxyId, '加载中', (res) => {
