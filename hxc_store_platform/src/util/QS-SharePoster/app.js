...
let _app = {
  ...
  getPosterUrl(objs) { // 后端获取背景图的url路径方法
    ...
    return new Promise((rs, rj) => {
      let image = backgroundImage || type == 1//根据type获取背景图, 一般要改成request获取
        ? ''
        : 'https://haoxiangchong.oss-cn-shenzhen.aliyuncs.com/MrJALsBtjt_wx023ed2d5e1a87230.o6zAJs5b-NeM9YlE0KCOW3BfXCAY.Y7hV2SHHxtUn28165f59b7bc31fdcc77e65ec36d1ce6.jpg';
      image
