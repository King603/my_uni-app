<template>
	<view class="box my-pd-15">
		<view class="box my-flex-row-align-c">
			<image class="pic" src="/static/my/help.png" mode="aspectFit"></image>
			<text class="my-mgl-8 my-font-16">豪想百科</text>
		</view>
		<view class="box my-flex-col my-bg-white my-mgt-5 my-rds-5 my-pdlr-10 my-relative h">
			<view class="my-flex-col box" v-for="(item,index) in tab" :key="index" @click="onTab(index)">
				<view class="my-flex-row-b bder-b my-pdtb-8">
					...
					<image class="icon my-flex-self-s" :class="select===index?'tr2':'tr1'" src="/static/my/bottom.png" mode="aspectFit"></image>
				</view>
		...
		<view class="my-mgt-15 box my-flex-row-c" @click="kefu">
			<view class="btn my-flex-row-c my-bg-ye my-cl-white my-font-22 my-boxsha-2">
				<image class="f-icon" src="/static/my/service.png" mode="aspectFit"></image>
