		...
		<view class="box1 bg my-flex-row-b" style="z-index: 8888;">
			<view class="my-flex-row-align-c">
				<view class="avater my-pdlr-15 bder-r-white" @click="onGoHome">
					<image :src="avatarUrl" style="width:60upx;height:60upx;border-radius: 50%;"></image>
				</view>
				<view class="my-flex-row-b h my-pdl-10">
					<view class="my-flex-row-align-c">
						<image class="search" src="/static/hch-position/search.png" mode="aspectFit"></image>
						<view class="h2">
							<input class="input" type="text" @blur="blurName" :value="name" style="height:40upx;width: 345upx;" placeholder="请输入你想要前往的网点名称" placeholder-class="my-cl-white2"/>
						</view>
					</view>
